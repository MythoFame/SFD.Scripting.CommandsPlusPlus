...
public partial class GameScript : GameScriptInterfaceExtended
{
    ...
    public static class Vector2Helper
    {
        ...
        /// </summary>
        public static float AngleTo(Vector2 v, Vector2 to) => (float)Math.Atan2(Cross(v, to), Vector2.Dot(to, v));

        /// <summary>
        /// Returns the angle (in radians) from one vector to another point.
        /// </summary>
        public static float AngleToPoint(Vector2 v, Vector2 to) => (float)Math.Atan2(to.Y - v.Y, to.X - v.X);

        /// <summary>
        /// Returns the aspect ratio of the specified vector (X / Y).
        /// </summary>
        public static float Aspect(Vector2 v) => v.X / v.Y;

        /// <summary>
        /// Reflects a vector off the specified normal vector.
        /// </summary>
        public static Vector2 Bounce(Vector2 v, Vector2 normal) => -Reflect(v, normal);

        /// <summary>
        /// Returns the ceiling of each component of the specified vector.
        /// </summary>
        public static Vector2 Ceiling(Vector2 v) => new((float)Math.Ceiling(v.X), (float)Math.Ceiling(v.Y));

        /// <summary>
        /// Restricts each component of the specified vector to the specified range.
        /// </summary>
        public static Vector2 Clamp(Vector2 v, Vector2 min, Vector2 max) => new(MathHelper.Clamp(v.X, min.X, max.X),
                MathHelper.Clamp(v.Y, min.Y, min.Y));

        /// <summary>
        /// Calculates the cross product of two vectors.
        /// </summary>
        public static float Cross(Vector2 v, Vector2 with) => (v.X * with.Y) - (v.Y * with.X);

        /// <summary>
        /// Returns a unit vector pointing from one vector to another.
        /// </summary>
        public static Vector2 DirectionTo(Vector2 v, Vector2 to) => Vector2.Normalize(new Vector2(to.X - v.X, to.Y - v.Y));

        /// <summary>
        /// Returns the floor of each component of the specified vector.
        /// </summary>
        public static Vector2 Floor(Vector2 v) => new((float)Math.Floor(v.X), (float)Math.Floor(v.Y));

        /// <summary>
        /// Returns the inverse of each component of the specified vector.
        /// </summary>
        public static Vector2 Inverse(Vector2 v) => new(1 / v.X, 1 / v.Y);

        /// <summary>
        /// Determines whether the specified vector is normalized.
        /// </summary>
        public static bool IsNormalized(Vector2 v) => Math.Abs(v.LengthSquared() - 1) < float.Epsilon;
        ...
        /// </summary>
        public static Vector2 Project(Vector2 v, Vector2 onNormal) => onNormal * (Vector2.Dot(onNormal, v) / onNormal.LengthSquared());
        ...
        /// </summary>
        public static Vector2 Round(Vector2 v) => new((float)Math.Round(v.X), (float)Math.Round(v.Y));
        ...
        /// </summary>
        public static Vector2 Slide(Vector2 v, Vector2 normal) => v - (normal * Vector2.Dot(normal, v));

        /// <summary>
        /// Returns an orthogonal vector to the specified vector.
        /// </summary>
        public static Vector2 Orthogonal(Vector2 v) => new(v.Y, -v.X);
